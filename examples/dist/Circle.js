...
if( typeof Circle.initialized == "undefined" ) {
    ...
    */
    Circle.prototype.addPhysics = function(world,rest) {
        ...
        if (this.categoryBits != -1) {
            this.ballSd.categoryBits = this.categoryBits;
        }
        if (this.categoryMask != -1) {
            this.ballSd.maskBits = this.categoryMask;
        }
    ...
    */
    ...
    Circle.prototype.setCollisionFilter = function(c) {
        this.categoryBits = c;
    };

    Circle.prototype.setCollisionMask = function(m) {
        this.categoryMask = m;
    };
